...
import com.example.chen.finder.drawables.RoundedDrawable;
...
public class RoundedImageView extends ImageView {
    ...
    private ColorStateList borderColor =
            ColorStateList.valueOf(com.example.chen.finder.drawables.RoundedDrawable.DEFAULT_BORDER_COLOR);
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_border_width_RoundedImageView, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView_border_color_RoundedImageView);
        if (borderColor == null) {
